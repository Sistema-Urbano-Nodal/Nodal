...
- `output/` holds local generated documents and is not versioned.

## Requirements

- Node.js 22.13 or newer within the 22.x release line (the runtime used by CI and Vercel).
...
Run `npm run build` before publishing. It checks JavaScript for undefined names,
unused variables, duplicate keys, and unreachable code, runs the tests, then

(() => {
  ...
  another.addEventListener('click',()=>{requestMode();message.hidden=true;email.focus();});
  ...
  requestForm.addEventListener('submit',async event=>{
    ...
    const button=requestForm.querySelector('button[type="submit"]');button.disabled=true;button.dataset.recoveryText='sending';apply();
    try{
    ...
    finally{button.disabled=false;button.dataset.recoveryText='request';apply();}
  });
  resetForm.addEventListener('submit',async event=>{
    ...
    const button=resetForm.querySelector('button[type="submit"]');button.disabled=true;button.dataset.recoveryText='saving';apply();
    try{
    ...
    finally{button.disabled=false;button.dataset.recoveryText='save';apply();}
  });
})();

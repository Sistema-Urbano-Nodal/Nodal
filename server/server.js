...
const STATIC_PAGES = new Set(['index.html', 'login.html', 'dashboard.html', 'profile.html', 'payments.html', 'opportunities.html']);
const STATIC_SCRIPTS = new Set(['app.js', 'auth.js', 'catalog.js', 'coastline.js', 'dashboard.js', 'globe.js', 'globe-geo.js', 'i18n.js', 'nav.js', 'payments.js', 'profile.js', 'recs.js', 'script.js']);
const STATIC_STYLES = new Set(['styles.css', 'dashboard.css', 'catalog.css']);
